...
namespace CastleGrimtol.Project
{
    public class GameService : IGameService
    {
        ...
        public void Setup()
        {
            Room ship = new Room("Ship", "Your ship has been your home for the last several years as you've been in cryo sleep on your way to investigate the loss of communications from humans first space station in a new solar system.");
...
*/
        ...
        void Decision()
        {
            ...
            switch (decision.ToLower()[0])
            {
                case 'd':
                    Console.Clear();
                    Console.WriteLine("As a true Investigator you dock to Station Hope preparing for whatever the unknown has in store for you. You don't even know the meaning of fear, which some would argue is a stupid way heading into the unknown but what do those people know psh.");
